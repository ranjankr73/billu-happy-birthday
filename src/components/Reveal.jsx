...
export default function Reveal() {
    ...
    const togethernessPhotos = [
        "/photos/together1.jpeg",
        "/photos/together2.jpeg",
        "/photos/together3.jpeg",
        "/photos/together4.jpeg",
        "/photos/together5.jpeg",
        "/photos/together6.jpeg",
        "/photos/together7.jpeg",
        "/photos/together8.jpeg",
        "/photos/together9.jpeg",
        "/photos/together10.jpeg",
        "/photos/together11.jpeg",
        "/photos/together12.jpeg",
        "/photos/together13.jpeg",
        "/photos/together14.jpeg",
        "/photos/together15.jpeg",
        "/photos/together16.jpeg",
        "/photos/together17.jpeg",
        "/photos/together18.jpeg",
    ];
    const friendsPhotos = [
        "/photos/friend1.jpeg",
        "/photos/friend2.jpeg",
        "/photos/friend3.jpeg",
    ]; // Assume you have these paths
    const togethernessAudioRef = React.useRef(null);
    const sayariAudioRef = React.useRef(null);

    const reelDuration = 180;
    const photoWidth = 256;
    const gap = 24;
    const totalPhotos = togethernessPhotos.length;
    const stripWidth = totalPhotos * (photoWidth + gap);
            ...
            {showTogetherness && (
                <div className="absolute inset-0 z-[50] overflow-hidden flex items-center justify-center bg-black/40 backdrop-blur-sm">
                    ...
                    <motion.div
                        ...
                        initial={{ x: window.innerWidth }} // start off-screen right
                        animate={{ x: -(stripWidth + window.innerWidth) }} // move past left edge
                        transition={{
                            duration: reelDuration, // 120 seconds
                            ease: "linear",
                        }}
                    >
                    ...
                    <TogethernessReelTimer
                        onComplete={handleTogethernessEnd}
                        duration={120000}
                    />
                </div>
            )}
            ...
            {showSayari && (
                ...
                >
                    <p className="text-center">
                        “Teri ek jhalak paane ko intezaar karta hoon, Har roz
                        tere husn ka be-intehaa didaar karta hoon, Jis din tu
                        mili thi mujhse, bas tab se yahi khwaab rakhta hoon,
                        Teri baahon mein samaa jaaun… yehi dua main rab se har
                        baar karta hoon.” 💫
                    </p>
                    <motion.h2
